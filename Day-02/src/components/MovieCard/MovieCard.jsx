...
import { FiPlay, FiPlus, FiThumbsUp, FiChevronDown, FiCheck } from 'react-icons/fi';
...
export default function MovieCard({ movie, index, onClick }) {
  ...
  // Use List context for "My List" functionality
  const { isInList, toggleList } = useList();
      ...
      <div className="movie-card__hover">
        ...
        <div className="movie-card__hover-info">
          <div className="movie-card__hover-actions">
            ...
            <button 
              className={`movie-card__action-btn ${inList ? 'active' : ''}`} 
